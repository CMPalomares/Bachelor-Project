         ...
         if (dist(d1.x, d1.y, d2.x, d2.y)<100) {
          for (int k=j+1; k<dots.size(); k++) {
           ...
           if (dist(d2.x, d2.y, d3.x, d3.y)<100) {
            fill(0,10);
            ellipse(_s.skeletonPositions[_C1].x*width, _s.skeletonPositions[_C1].y*height, d1.x-600, d1.y-600);
            //ellipse(d1.x, d1.y, 300, 300);
            ellipse(_s.skeletonPositions[_C3].x*width, _s.skeletonPositions[_C3].y*height,d3.x-600, d3.y-600); 
           // ellipse(d3.x, d3.y, 300, 300);
